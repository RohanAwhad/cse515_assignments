...
def retrieve(img_id):
  ...
  color_mmt_top_k_imgs = [config.DATASET[COLOR_MMT_IDX[x]][0] for x in color_mmt_top_k_img_ids]
  ...
  hog_top_k_imgs = [config.DATASET[HOG_IDX[x]][0] for x in hog_top_k_img_ids]
  top_k_imgs.append(hog_top_k_imgs)
  top_k_ids.append([HOG_IDX[x] for x in hog_top_k_img_ids])
